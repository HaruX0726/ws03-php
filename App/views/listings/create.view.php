    ...
    <form method="POST" action="/listings" class="bg-white rounded-lg shadow-md p-8 border border-gray-700">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="title" name="title" placeholder="Job Title"
                value="<?= htmlspecialchars($_POST['title'] ?? $listing->title ?? '') ?>"
        ...
        <div class="mb-4">
            ...
            <textarea id="description" name="description" rows="4" placeholder="Job Description"
        ...
        <div class="mb-4">
            ...
            <input type="text" id="salary" name="salary" placeholder="Annual Salary"
                value="<?= htmlspecialchars($_POST['salary'] ?? $listing->salary ?? '') ?>"
                class="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500 text-white" />
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="requirements" name="requirements" placeholder="Requirements"
                value="<?= htmlspecialchars($_POST['requirements'] ?? $listing->requirements ?? '') ?>"
                class="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500 text-white" />
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="benefits" name="benefits" placeholder="Benefits"
                value="<?= htmlspecialchars($_POST['benefits'] ?? $listing->benefits ?? '') ?>"
                class="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500 text-white" />
        </div>
        ...
        <div class="mb-6">
            ...
            <input type="text" id="tags" name="tags" placeholder="Tags"
                value="<?= htmlspecialchars($_POST['tags'] ?? $listing->tags ?? '') ?>"
                class="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500 text-white" />
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="company" name="company" placeholder="Company Name"
                value="<?= htmlspecialchars($_POST['company'] ?? $listing->company ?? '') ?>"
                class="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500 text-white" />
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="address" name="address" placeholder="Address"
                value="<?= htmlspecialchars($_POST['address'] ?? $listing->address ?? '') ?>"
                class="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500 text-white" />
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="city" name="city" placeholder="City"
                value="<?= htmlspecialchars($_POST['city'] ?? $listing->city ?? '') ?>"
                class="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500 text-white" />
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="state" name="state" placeholder="State"
                value="<?= htmlspecialchars($_POST['state'] ?? $listing->state ?? '') ?>"
                class="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500 text-white" />
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="phone" name="phone" placeholder="Phone"
                value="<?= htmlspecialchars($_POST['phone'] ?? $listing->phone ?? '') ?>"
                class="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500 text-white" />
        </div>
        ...
        <div class="mb-8">
            ...
            <input type="email" id="email" name="email" placeholder="Email Address For Applications"
                value="<?= htmlspecialchars($_POST['email'] ?? $listing->email ?? '') ?>"
                class="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500 text-white" />
        </div>
        ...
        <div class="flex flex-col gap-3">
            ...
            <a href="/listings" class="btn-cancel">
